...
export const lessons={
  ...
  'nested-heart':{name:'Heart-in-a-heart',short:'Nested heart',level:'Intermediate',duration:36,number:'04',bounds:[0,.3,.55,.8,1],labels:['BASE','OUTER HEART','INNER HEART','FINISH'],description:'A little heart held inside a larger one. Practice two pours with a delicate border of crema between them.',tip:'Stop the first pour cleanly. Return gently to the near side so the second pool sits inside the first.',steps:[
